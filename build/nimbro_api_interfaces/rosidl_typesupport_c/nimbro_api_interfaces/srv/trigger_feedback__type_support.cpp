...
static const _TriggerFeedback_Request_type_support_symbol_names_t _TriggerFeedback_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, TriggerFeedback_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, TriggerFeedback_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, TriggerFeedback_Request)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::TriggerFeedback_Request_message_type_support_handle;
}
...
static const _TriggerFeedback_Response_type_support_symbol_names_t _TriggerFeedback_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, TriggerFeedback_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, TriggerFeedback_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_nimbro_api_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, TriggerFeedback_Response)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::TriggerFeedback_Response_message_type_support_handle;
}
...
static const _TriggerFeedback_type_support_symbol_names_t _TriggerFeedback_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, TriggerFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, TriggerFeedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, TriggerFeedback)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::TriggerFeedback_service_type_support_handle;
}
