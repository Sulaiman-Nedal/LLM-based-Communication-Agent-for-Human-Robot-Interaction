...
static const _GetUsage_Request_type_support_symbol_names_t _GetUsage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, GetUsage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, GetUsage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, GetUsage_Request)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::GetUsage_Request_message_type_support_handle;
}
...
static const _GetUsage_Response_type_support_symbol_names_t _GetUsage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, GetUsage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, GetUsage_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_nimbro_api_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, GetUsage_Response)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::GetUsage_Response_message_type_support_handle;
}
...
static const _GetUsage_type_support_symbol_names_t _GetUsage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nimbro_api_interfaces, srv, GetUsage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nimbro_api_interfaces, srv, GetUsage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nimbro_api_interfaces, srv, GetUsage)() {
  return &::nimbro_api_interfaces::srv::rosidl_typesupport_c::GetUsage_service_type_support_handle;
}
