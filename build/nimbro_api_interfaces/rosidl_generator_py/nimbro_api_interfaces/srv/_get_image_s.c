...
bool nimbro_api_interfaces__srv__get_image__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nimbro_api_interfaces.srv._get_image.GetImage_Request", full_classname_dest, 53) == 0);
  }
  nimbro_api_interfaces__srv__GetImage_Request * ros_message = _ros_message;
  {  // prompt
  ...
  {  // quality
    ...
    rosidl_runtime_c__String__assign(&ros_message->quality, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // style
...
{
  /* NOTE(esteve): Call constructor of GetImage_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nimbro_api_interfaces.srv._get_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetImage_Request");
  ...
  {  // quality
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->quality.data,
      strlen(ros_message->quality.data),
      "replace");
    if (!field) {
      return NULL;
    }
...
ROSIDL_GENERATOR_C_EXPORT
bool nimbro_api_interfaces__srv__get_image__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nimbro_api_interfaces.srv._get_image.GetImage_Response", full_classname_dest, 54) == 0);
  }
  nimbro_api_interfaces__srv__GetImage_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of GetImage_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nimbro_api_interfaces.srv._get_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetImage_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
