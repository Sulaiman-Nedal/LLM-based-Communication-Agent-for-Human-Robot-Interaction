...
static const _Embedding_type_support_symbol_names_t _Embedding_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nimbro_api_interfaces, msg, Embedding)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nimbro_api_interfaces, msg, Embedding)),
  }
};
...
{
  return &::nimbro_api_interfaces::msg::rosidl_typesupport_cpp::Embedding_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nimbro_api_interfaces, msg, Embedding)() {
  return get_message_type_support_handle<nimbro_api_interfaces::msg::Embedding>();
}
