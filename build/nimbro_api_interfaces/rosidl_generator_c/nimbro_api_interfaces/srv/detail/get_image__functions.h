...
#ifndef NIMBRO_API_INTERFACES__SRV__DETAIL__GET_IMAGE__FUNCTIONS_H_
#define NIMBRO_API_INTERFACES__SRV__DETAIL__GET_IMAGE__FUNCTIONS_H_
 ...
 * calls
 * nimbro_api_interfaces__srv__GetImage_Request__init().
...
/**
 * It calls
 * nimbro_api_interfaces__srv__GetImage_Request__fini()
 ...
 * nimbro_api_interfaces__srv__GetImage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * nimbro_api_interfaces__srv__GetImage_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nimbro_api_interfaces__srv__GetImage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nimbro_api_interfaces
...
/**
 * It calls
 * nimbro_api_interfaces__srv__GetImage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nimbro_api_interfaces
...
/**
 * It allocates the memory for the array and calls
 * nimbro_api_interfaces__srv__GetImage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nimbro_api_interfaces
...
/**
 * It calls
 * nimbro_api_interfaces__srv__GetImage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NIMBRO_API_INTERFACES__SRV__DETAIL__GET_IMAGE__FUNCTIONS_H_
