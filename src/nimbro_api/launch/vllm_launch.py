...
launch_args = [
    ...
    DeclareLaunchArgument('nimbro_api_completions_api_flavor', default_value='vllm', choices=['openai', 'mistral', 'vllm'], description='Sets API and accommodates for differences in their specifications.'),
    DeclareLaunchArgument('nimbro_api_completions_model_name', default_value='nm-testing/pixtral-12b-FP8-dynamic', description='Name of the model that is used.'),
