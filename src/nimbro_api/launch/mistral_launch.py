...
launch_args = [
    ...
    DeclareLaunchArgument('nimbro_api_completions_api_flavor', default_value='mistral', choices=['openai', 'mistral', 'vllm'], description='Sets API and accommodates for differences in their specifications.'),
    DeclareLaunchArgument('nimbro_api_completions_model_name', default_value='mistral-large-latest', description='Name of the model that is used.'),
